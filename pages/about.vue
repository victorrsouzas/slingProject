<template>
  <section class="container">
    <h1>Conheça mais sobre o SlingProject</h1>
    <p class="subheading">
      Descubra mais sobre o SlingProject! Clique no botão abaixo para acessar o
      repositório no GitHub e contribuir com o projeto.
    </p>
    <a
      href="https://github.com/victorrsouzas/slingProject"
      target="_blank"
